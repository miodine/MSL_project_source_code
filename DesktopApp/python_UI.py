...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dynamic_plot = QtWidgets.QVBoxLayout(self.horizontalLayoutWidget_4)
        ...
        self.button_velocity_minus.clicked.connect(self.event_decrease_velocity)
        self.button_send_custom_tuning.clicked.connect(self.event_updatePIDFromValues)
        self.button_send_default_tuning.clicked.connect(self.event_updatePIDDefault)
...
## CLASS METHODS
    ...
    def reg_quality_update(self):
        self.RPM_actual, self.RPM_set, self.status,self.enc_used  = self.serial_handler.read_data(self.RPM_actual, self.RPM_set, self.status, self.input_logger, self.output_logger, self.logging_started)    
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_transmit_data.setText(_translate("MainWindow", "Update tunig and/or velocity"))
        self.label_velocity.setText(_translate("MainWindow", "New RPM value: "))
        ...
        self.var_monit.setText(_translate("MainWindow", "Program started, and it is probably working properly."))
...
##  EVENTS 
    ...
    def event_start_logging(self):
        ...
        self.input_logger.write("Log started at: " + str(datetime.now()) + "\n")
        self.input_logger.write("Logs taken each 1s. \r\n")
        
        self.output_logger.write("Log started at: " + str(datetime.now()) + "\n")
    ...
    def event_stop_logging(self):
        ...
        self.input_logger.write("Log stopped at: " + str(datetime.now()) + "\r\n")
        self.output_logger.write("Log stopped at: " + str(datetime.now()) + "\r\n")
